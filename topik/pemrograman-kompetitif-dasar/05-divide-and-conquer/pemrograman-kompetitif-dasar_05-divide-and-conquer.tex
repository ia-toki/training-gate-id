...
%\begin{itemize}
%  \item Umumnya \fDivideAndConquer memiliki sifat rekursif secara alami.
...
\begin{itemize}
  \item \foreignTerm{Divide}: jika \farray berukuran besar, bagi menjadi dua subarray.
  \item \foreignTerm{Conquer}: ketika \farray hanya berisi satu elemen, nilai terbesarnya pasti elemen tersebut.
  \item \foreignTerm{Combine}: nilai terbesar dari \farray adalah maksimum dari nilai terbesar di subarray pertama dan nilai terbesar di subarray kedua.
\end{itemize}
\end{frame}
