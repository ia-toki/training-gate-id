...
\foreignTerm{Linked list} terdiri dari kumpulan \alert{\foreignTerm{node}}.\newline
...
\begin{itemize}
  \item \foreignTerm{Push}, yaitu memasukan elemen baru ke bagian atas tumpukan.
...
\begin{itemize}
  \item \foreignTerm{Stack} juga digunakan pada kalkulator ekspresi matmatika dalam notasi postfix.
...
\begin{itemize}
  \item Diberikan sebuah ekspresi dalam notasi postfix, nilai akhirnya dapat dicari dengan skema kerja \foreignTerm{stack}.
...
\begin{itemize}
  ...
  \item Struktur data \foreignTerm{queue} mirip dengan analogi antrian tersebut.
...
\begin{itemize}
  \item Struktur data \foreignTerm{queue} menyimpan informasi dalam bentuk antrian.
...
\begin{itemize}
  \item \foreignTerm{Push}, yaitu memasukkan elemen baru ke bagian akhir antrian.
  \item \foreignTerm{Pop}, yaitu mengeluarkan elemen paling depan antrian.
  \item \foreignTerm{Front}, yaitu mengakses elemen yang paling depan antrian.
\end{itemize}
\end{frame}
...
\begin{itemize}
  \item Sesuai namanya, pada komputer \foreignTerm{queue} digunakan untuk berbagai hal yang memerlukan antrian.
  \item Misalnya antrian berkas-berkas yang akan diunduh dari internet untuk ditampilkan pada \foreignTerm{browser} Anda.
