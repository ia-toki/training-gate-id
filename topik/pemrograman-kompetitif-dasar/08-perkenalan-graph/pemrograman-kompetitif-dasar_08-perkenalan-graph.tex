...
\begin{itemize}
  ...
  \newline
  \item Pada beberapa kasus, digunakan struktur data \foreignTerm{Binary Search Tree} untuk menyimpan daftar \fedge, yang memungkinkan implementasinya lebih efisien.
