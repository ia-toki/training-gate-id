...
\begin{itemize}
  \item Apabila suatu proses dapat dibagi menjadi \foreignTerm{N sub-proses berbeda} yang mana terdapat $a_{i}$ cara untuk menyelesaikan sub-proses ke-i.
...
\begin{itemize}
  \item Apabila suatu proses dapat dibagi menjadi \foreignTerm{N himpunan proses berbeda} yaitu $H_{1}, H_{2}, H_{3}, ... , H_{N}$ dengan setiap himpunannya \foreignTerm{saling lepas} (tidak beririsan).
...
\begin{itemize}
  \item Apabila terdapat \foreignTerm{n objek} dan kita akan mengambil \foreignTerm{r objek} dari n objek tersebut yang mana $r<n$ dan \foreignTerm{urutan pengambilan diperhitungkan}.
...
%  \item Apabila kita menemukan angka yang belum kita gunakan, maka rekursi ke state selanjutnya yang mana jumlah objek dalam stack kita telah bertambah 1.
%\end{itemize}
%\end{frame}
%
%\begin{frame}[fragile]
...
%  \item Banyak permutasi yang ada adalah $P^{n}_{r}$ yang mana setiap permutasinya kita mengiterasi sebanyak N kali.
...
\begin{itemize}
  \item Apabila terdapat \foreignTerm{n objek} dan kita akan mengambil \foreignTerm{r objek} dari n objek tersebut dengan $r<n$ dan \foreignTerm{urutan pengambilan tidak diperhitungkan}.
...
\begin{itemize}
  \item Terdapat n jenis objek yang mana kita akan mengambil r objek, dan \foreignTerm{tiap objeknya dapat tidak diambil/diambil lebih dari 1 kali}.
