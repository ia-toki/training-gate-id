...
\begin{itemize}
  \item Kita dapat menggunakan \textit{array} \progTerm{boolean} untuk menyimpan informasi apakah suatu bilangan telah tereliminasi.
...
\begin{itemize}
  ...
  \item Anggap \textit{array}-nya bernama $A$ dan dimulai dari indeks 1 (\foreignTerm{one-based}).
