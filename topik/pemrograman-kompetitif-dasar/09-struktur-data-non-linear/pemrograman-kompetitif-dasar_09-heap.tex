...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item Pastikan \fsubtree yang bermula pada \fnode $x$ \textbf{membentuk \pheap} dengan operasi baru, yaitu \textbf{heapify}.
  \end{itemize}
\end{enumerate}
\end{frame}
...
\begin{itemize}
  ...
  \item Kegiatan ini sebenarnya sangat mirip dengan yang kita lakukan pada operasi \textbf{pop}.
\end{itemize}
\end{frame}
