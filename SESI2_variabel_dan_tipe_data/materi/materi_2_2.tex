...
\begin{itemize}
	\item Pada \textbf{readln}, setelah program membaca input, program akan disiapkan untuk membaca input selanjutnya di \alert{baris berikutnya}.
	\item Sementara pada \textbf{read}, setelah program membaca input, program akan disiapkan untuk membaca input selanjutnya di \alert{baris yang sama}.
\end{itemize}
\end{frame}
...
\begin{itemize}
	\item Seperti yang sudah kita gunakan selama ini, \textbf{writeln} akan mencetak seluruh \textbf{string}, karakter, angka, atau variabel yang diberikan, lalu \alert{mencetak} sebuah baris baru.
	\item Fungsi \textbf{write} memiliki kegunaan yang sama, tetapi \alert{tidak mencetak} baris baru di akhir percetakan,
\end{itemize}
\end{frame}
